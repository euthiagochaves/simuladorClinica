...
INSERT INTO perguntas (texto, secao, categoria, resposta_padrao, ordem_exibicao) VALUES
    -- Dolor
    ('¿Tiene dolor de cabeza?',             'Anamnesis', 'Dolor',           'No refiere cefalea.',                          1),
    ('¿Tiene dolor en el pecho?',           'Anamnesis', 'Dolor',           'No refiere dolor torácico.',                   2),
    ('¿Tiene dolor abdominal?',             'Anamnesis', 'Dolor',           'No refiere dolor abdominal.',                  3),
    ('¿Tiene dolor de espalda?',            'Anamnesis', 'Dolor',           'No refiere dolor lumbar ni dorsal.',           4),
    ('¿Tiene dolor en las articulaciones?', 'Anamnesis', 'Dolor',           'No refiere artralgias.',                       5),

    -- Fiebre
    ('¿Tiene fiebre?',                      'Anamnesis', 'Fiebre',          'Temperatura corporal normal (36.5°C).',        6),
    ('¿Ha tenido escalofríos?',             'Anamnesis', 'Fiebre',          'No refiere escalofríos.',                      7),

    -- Respiratorio
    ('¿Tiene dificultad para respirar?',    'Anamnesis', 'Respiratorio',    'No refiere disnea.',                           8),
    ('¿Tiene tos?',                         'Anamnesis', 'Respiratorio',    'No refiere tos.',                              9),
    ('¿Expectora algo?',                    'Anamnesis', 'Respiratorio',    'No refiere expectoración.',                   10),

    -- Gastrointestinal
    ('¿Tiene náuseas o vómitos?',           'Anamnesis', 'Gastrointestinal','No refiere náuseas ni vómitos.',              11),
    ('¿Tiene diarrea?',                     'Anamnesis', 'Gastrointestinal','Tránsito intestinal normal.',                 12),
    ('¿Tiene estreñimiento?',              'Anamnesis', 'Gastrointestinal','No refiere estreñimiento.',                   13),
    ('¿Ha perdido el apetito?',             'Anamnesis', 'Gastrointestinal','Apetito conservado.',                         14),

    -- Cardiovascular
    ('¿Tiene palpitaciones?',              'Anamnesis', 'Cardiovascular',  'No refiere palpitaciones.',                   15),
    ('¿Se le hinchan los pies o tobillos?', 'Anamnesis', 'Cardiovascular',  'No refiere edema en miembros inferiores.',    16),

    -- Neurológico
    ('¿Tiene mareos?',                     'Anamnesis', 'Neurológico',     'No refiere mareos ni vértigo.',               17),
    ('¿Ha perdido la consciencia?',         'Anamnesis', 'Neurológico',     'No refiere pérdida de consciencia.',          18),
    ('¿Tiene problemas de visión?',         'Anamnesis', 'Neurológico',     'Agudeza visual conservada.',                  19),

    -- Antecedentes
    ('¿Tiene alguna enfermedad conocida?',  'Anamnesis', 'Antecedentes',    'Niega antecedentes patológicos conocidos.',   20),
    ('¿Toma algún medicamento?',            'Anamnesis', 'Antecedentes',    'No toma medicamentos de forma regular.',      21),
    ('¿Es alérgico a algún medicamento?',   'Anamnesis', 'Antecedentes',    'Niega alergias medicamentosas conocidas.',    22),
    ('¿Ha sido operado alguna vez?',         'Anamnesis', 'Antecedentes',    'Niega antecedentes quirúrgicos.',            23),
    ('¿Tiene antecedentes familiares importantes?', 'Anamnesis', 'Antecedentes', 'Sin antecedentes familiares relevantes.',24),

    -- Hábitos
    ('¿Fuma?',                              'Anamnesis', 'Hábitos',         'Niega tabaquismo.',                           25),
    ('¿Consume alcohol?',                   'Anamnesis', 'Hábitos',         'Consumo social ocasional.',                   26),
    ('¿Consume drogas?',                    'Anamnesis', 'Hábitos',         'Niega consumo de sustancias.',                27);
